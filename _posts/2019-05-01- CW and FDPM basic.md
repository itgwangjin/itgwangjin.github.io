...
3. phantom의  $\mu_a$, $\mu_s'$와 $f$ 을 [*Rtherory*](https://www.spiedigitallibrary.org/journalArticle/Download?fullDOI=10.1117%2F1.3523616) 공식을 통해  diffuse reflectance R $A_{theoretical}$, $P_{theoretical}$ 구한다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjAzMjU5NjMsLTg2NjUwNTIzOSwtMT
